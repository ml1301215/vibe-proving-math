...
`vibe_proving` 是面向数学领域学生和研究者的 AI 平台。将语言模型与定理检索集成，支持学习、求解、审查、检索等交互式工作流。
...
该架构降低了数学场景中的幻觉风险，在准确性至关重要的情况下尤为重要。
...
- **形式化**：Harmonic Aristotle 支持 Lean 4

## 部署

通过 `config.toml` 或 Web 界面（推荐）配置：
